...
import { Check, Loader, SearchIcon, X } from "lucide-react";
...
export function NewChatDialog({ onOpenChange, onChatCreated }: Props) {
  ...
  const mutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        variant: "destructive",
        description: "Error starting chat. Please start again.",
      });
    },
  });
      ...
      <DialogContent className="bg-card p-0">
        ...
        <div>
          ...
          <div className="h-96 overflow-y-auto">
            ...
            {isFetching && <Loader className="mx-auto my-3 animate-spin" />}
            {isError && (
